...
#		   Sales performance table (sales_performance)                   #
...
#  Level of aggregation: order_item_id                                   #
...
#  Level of aggregation: website_session_id                              #
...
# ---------------------------------------------------------------------- #
#  4. Trigger for new order information                                  #
# ---------------------------------------------------------------------- #
...
-- Create trigger for website_activity table
...
-- Let's say that there is a customer who cames via gsearch, and bought one toy. In its session he navigated from the home page to the the order confirmation page.
